...
$(document).ready(function () {
  ...
  var elementsMap = $.map([inputAmount, inputTea, inputNumberFee], function (el) {
    return el.get();
  });
  /**
  ...
  inputNumberFee.change(function () {
    if (inputNumberFee.val() > 36) {
  ...
  calculateButton.click(function () {
    ...
    var valueTea = Number(inputTea.val()) / 100;
    var valueTem = Math.pow(1 + valueTea, 1 / 12) - 1;
    valueTem = Math.round(valueTem * Math.pow(10, 4)) / Math.pow(10, 4);
    var valueAmount = Number(inputAmount.val()),
        valueNumberFee = Number(inputNumberFee.val());
    var valueCuota = valueAmount * (valueTem * Math.pow(1 + valueTem, valueNumberFee)) / (Math.pow(1 + valueTem, valueNumberFee) - 1);
    valueCuota = Math.round(valueCuota * Math.pow(10, 2)) / Math.pow(10, 2);
    var valueTotal = Math.round(valueCuota * valueNumberFee * Math.pow(10, 2)) / Math.pow(10, 2);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcalculadora_de_cuotas"] = self["webpackChunkcalculadora_de_cuotas"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/app.min"], () => (__webpack_require__("./src/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app.min"], () => (__webpack_require__("./src/sass/app.scss")))
